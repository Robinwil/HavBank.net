...
export type RegisterResult = { ok: true; body: unknown } | { ok: false; error: string };
...
export async function registerWithRegistry(opts: RegisterOpts): Promise<RegisterResult> {
